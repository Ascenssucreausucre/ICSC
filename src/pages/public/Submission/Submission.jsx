...
export default function Submission() {
  const { loading, data: data } = useFetch("/front-routes/submission");
        ...
        <>
          {fees && dates ? (
            <section>
              ...
              <p>
                ...
                the top below the top margin, should include the paper title,
                the authors' names and their affiliations, an abstract, and
                keywords.
              </p>
              <br />
              <p>
                ...
                <strong>{fees.additionnal_page_fee}</strong>€ per additional
                page.
              </p>
              <p>
              ...
              <p>
                ...
                <strong>
                  {new Date(
                    dates.paper_decision_notification
          ...
          <section>
            ...
            <p>
              ...
              electronically, through the Conference Website. Each such paper
              must be marked as 'Invited Session Paper'. Please go to the online
              paper submission site, and login using your PIN/Password (you have
              to register to get your PIN), to submit your contribution (please
          ...
          <section>
            ...
            <p>
              Please note that the paper size for final manuscripts must be set
              to 'letter format'. Full papers should be submitted in standard
              IEEE 10pt double-column format for conferences.
            </p>
            <p>
              For final submission, Please DO NOT use A4 rather use LETTER
              format and create the output in Letter format to upload.
            </p>
          </section>
          <section>
