    ...
    content: formData.isAuthor ? (
      <>
        <p>
          ...
          <strong className="important-info">{maxArticles}</strong> articles of
          which you are an author or a co-author. Each additional article will
          be factured{" "}
                ...
                {selectedArticles.length > 0 &&
                  selectedArticles.map((article, index) => {
                    ...
                    const extraPageFee =
                      extraPageCount > 0
                        ? `${
                            extraPageCount * additionalFees.additional_page_fee
                          }€`
                        : "-";
